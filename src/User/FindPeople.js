...
class FindPeople extends Component{
    ...
    .then( (data) => {
        ...
        else {      //remove newly followed user from updated user list now
        ...
        <div className = 'row'>
                ...
                <div className="card col-sm-3 mr-4 mt-4 mb-4 ml-4" key = {i}>
                   ...
                   <div className="card-body">
                     ...
                     <button onClick = {() => this.Follow(user,i)} className="btn btn-raised btn-info btn-sm float-right">Follow</button>
                   </div>
                </div>
                )})}
        </div>
